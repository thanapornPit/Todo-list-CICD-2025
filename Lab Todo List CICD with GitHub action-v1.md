...
<img width="1302" height="586" alt="image" src="https://github.com/user-attachments/assets/f56e3404-e53c-4597-95c3-ecb22dbcd40d" />
...
ส่วนของโค้ดจริง (Production Code) คือไฟล์ใน app/  ที่เป็น logic หลักของระบบ

ส่วนของการทดสอบ (Test Code) คือไฟล์ใน tests/ เช่น test_app.py ที่จำลองการเรียก API เพื่อตรวจสอบว่าผลลัพธ์ถูกต้องตามที่ออกแบบ

ความสัมพันธ์ระหว่างช่วยให้มั่นใจว่าทุก endpoint และฟังก์ชันหลักของแอปทำงานได้ถูกต้อง ครอบคลุม (ทั้งปกติและกรณี error) เพื่อให้ได้ code coverage ≥ 90%
